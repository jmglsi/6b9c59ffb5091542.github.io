...
// 把Windows的开发环境都卸载了，正好学习下 Linux ，还不怕折腾坏 XD ~
...
按照官网方法安装完以后重启一下 VS Code ，链接上 WSL 以后 **终端 -> 新建终端 -> 选择默认Shell** 不出意外应该就能看到 **/bin/zsh** 了（这也是我最喜欢 VS Code的地方，对我这种系统命令太多记不住的人来说太方便了）。
